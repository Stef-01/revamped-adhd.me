...
def head_for(p, head):
    ...
    subs = [
        (r'<!-- ADHDme - .*? -->', f'<!-- ADHDme - {p["seo"]} (generated by scripts/build-blog.py) -->'),
        ...
        (r'<meta property="og:image:alt" content=".*?">', f'<meta property="og:image:alt" content="Cover illustration for {p["seo"]}">'),
        (r'<meta name="twitter:image:alt" content=".*?">', f'<meta name="twitter:image:alt" content="Cover illustration for {p["seo"]}">'),
