...
ARTICLES = {
    ...
    'desr-emotional-regulation': ('https://www.additudemag.com/desr-adhd-emotional-regulation/', 2021, 'DESR: Why Deficient Emotional Self-Regulation is Central to ADHD', 'ADDitude Magazine', 'Dr Russell Barkley on why emotional self-regulation belongs at the centre of how we understand and treat ADHD.'),
    'treating-emotional-symptoms': ('https://www.additudemag.com/treating-adhd-emotional-symptoms/', 2021, 'Study: Emotional Symptoms of ADHD Mitigated by CBT and Skills Training', 'ADDitude Magazine', 'What the evidence says about CBT and skills-based approaches for the emotional side of ADHD in adults.'),
    'masking-signs': ('https://www.additudemag.com/adhd-masking-signs-consequences-solutions/', 2022, 'Why ADHD Masking Is a Form of Self-Sabotage', 'ADDitude Magazine', 'The signs and costs of hiding ADHD symptoms to appear neurotypical, and gentler alternatives to constant masking.'),
    'unmasking': ('https://www.psychologytoday.com/us/blog/empowered-with-adhd/202501/unmasking-with-adhd', 2025, 'Unmasking With ADHD', 'Psychology Today', 'What it looks like to stop performing neurotypicality after a late diagnosis, and how to do it safely at work and at home.'),
    'occupational-therapy': ('https://www.healthline.com/health/adhd/can-occupational-therapy-help-people-who-have-adhd', 2021, 'Can Occupational Therapy Help People Who Have ADHD?', 'Healthline', 'How occupational therapists support adults with ADHD through sensory strategies, routines, and environmental adjustments.'),
    'time-blindness-work': ('https://chadd.org/adhd-news/adhd-news-adults/attention-time-unbound-managing-time-blindness-at-work/', 2024, 'Time Unbound: Managing Time Blindness at Work', 'CHADD', 'The Four As framework, Adapt, Adjust, Ask and Accommodate, for handling time blindness in the workplace.'),
    'improve-executive-function': ('https://www.additudemag.com/how-to-improve-executive-function-adhd/', 2022, 'How to Sharpen Executive Functions: Activities to Hone Brain Skills', 'ADDitude Magazine', 'Evidence on which activities genuinely strengthen executive functions, and why they need to be challenged, not just used.'),
    'losing-track-of-time': ('https://www.additudemag.com/losing-track-of-time-adhd/', 2024, 'Losing Track of Time? 8 Ways to End ADHD Time Blindness', 'ADDitude Magazine', 'Concrete tools, from analogue clocks to transition alarms, that make the passage of time visible.'),
    'healthy-eating-adults': ('https://www.additudemag.com/healthy-eating-habits-adhd-adults/', 2020, 'Healthy Eating Habits for Impulsive, Dopamine-Starved ADHD Brains', 'ADDitude Magazine', ''),
    'nutrition-relationship-food': ('https://www.additudemag.com/proper-nutrition-adhd-relationship-with-food/', 2020, 'Build a Better Relationship with Food to Benefit Your Brain', 'ADDitude Magazine', ''),
    'time-perception': ('https://www.additudemag.com/wasting-time-adhd-and-time-perception/', 2023, 'How ADHD Warps Time Perception', 'ADDitude Magazine', 'Why time feels slippery with ADHD and strategies to stop wasting it and start managing it.'),
}

PLACEHOLDER_NOTE = 'This profile is being finalised with the practitioner. Credentials, fees and booking will appear here once confirmed.'
...
CLINICIANS = [
    ...
    dict(slug='dr-maya-lin', name='Dr Maya Lin', short='Dr Lin', creds='Psychologist',
         category='Psychologist • Assessment &amp; Neuro-Affirming Therapy', img='assets/dr-maya-lin.jpg',
         verified='Profile in progress', location='Double Bay &amp; Telehealth', placeholder=True,
         chips=[('videocam','Telehealth','blue'),('fact_check','ADHD diagnostic assessment','amber'),('dot','Neuro-affirming CBT','dot'),('mood','Emotional regulation','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         book_href='mailto:info@adhdme.au?subject=Booking%20enquiry%3A%20Dr%20Maya%20Lin', book_label='Enquire about Dr Lin', book_external=False,
         fee_badge='Fees at booking',
         fees=[('Diagnostic assessment','Fee and any Medicare rebate confirmed before you book','TBC'),('Therapy sessions','Fee and any Medicare rebate confirmed before you book','TBC')],
         fee_note='Exact fees and eligible Medicare rebates will be displayed here before booking opens.',
         quote='A diagnosis should hand you a clearer map of your own mind, not a label to carry. Therapy then works with the brain you have, not against it.',
         promises=[('videocam_off','#2563eb','Camera Optional'),('receipt_long','#d97706','Written Summary'),('favorite','#2563eb','Zero Judgment')],
         bio=['Dr Maya Lin is a psychologist listed in the ADHDme network for ADHD diagnostic assessment, neuro-affirming cognitive behavioural therapy, and emotional regulation work, consulting in Double Bay and by telehealth.', PLACEHOLDER_NOTE],
         focus=['ADHD diagnostic assessment','Neuro-affirming CBT','Emotional regulation','Telehealth and in-person sessions'],
         details=[('Languages','To be confirmed'),('Qualifications','To be confirmed'),('Appointments','To be confirmed'),('Consulting Mode','Double Bay practice &amp; telehealth')],
         stepfree='Not declared', newpatients='Enquire',
         articles=[('treating-emotional-symptoms','rec'),('desr-emotional-regulation','clin'),('masking-signs','prac')]),

    dict(slug='julian-vance', name='Julian Vance', short='Julian', creds='ADHD Coach',
         category='ADHD Coach • Late Diagnosis &amp; Burnout Recovery', img='assets/julian-vance.svg',
         verified='Profile in progress', location='Surry Hills &amp; Telehealth', placeholder=True,
         chips=[('videocam','Telehealth','blue'),('explore','Late-diagnosis coaching','amber'),('dot','Burnout recovery','dot'),('work','Executive coaching','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         book_href='mailto:info@adhdme.au?subject=Booking%20enquiry%3A%20Julian%20Vance', book_label='Enquire about Julian', book_external=False,
         fee_badge='Fees at booking',
         fees=[('Initial coaching session','Fee confirmed before you book','TBC'),('Ongoing sessions','Fee confirmed before you book','TBC')],
         fee_note='Coaching is not Medicare rebated. Exact fees will be displayed here before booking opens.',
         quote='A late diagnosis rewrites your past. Coaching is where we decide what the next chapter looks like, at a pace your nervous system can actually sustain.',
         promises=[('videocam_off','#2563eb','Camera Optional'),('receipt_long','#d97706','Written Summary'),('favorite','#2563eb','Zero Judgment')],
         bio=['Julian Vance is an ADHD coach listed in the ADHDme network for late-diagnosis coaching, burnout recovery, and executive coaching, working from Surry Hills and by telehealth.', PLACEHOLDER_NOTE],
         focus=['Late-diagnosis coaching','Burnout recovery','Executive coaching','Telehealth and in-person sessions'],
         details=[('Languages','To be confirmed'),('Qualifications','To be confirmed'),('Appointments','To be confirmed'),('Consulting Mode','Surry Hills &amp; telehealth')],
         stepfree='Not declared', newpatients='Enquire',
         articles=[('unmasking','rec'),('neurodivergent-burnout','clin'),('executive-dysfunction','prac')]),

    dict(slug='sarah-jenkins', name='Sarah Jenkins', short='Sarah', creds='Occupational Therapist',
         category='Occupational Therapist • Passionate about ADHD', img='assets/sarah-jenkins.jpg',
         verified='Profile in progress', location='Paddington &amp; Clinic Visit', placeholder=True,
         chips=[('favorite','Passionate about ADHD','amber'),('sensors','Sensory profiling','blue'),('dot','Executive functioning scaffolding','dot'),('home_health','Clinic visits','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         book_href='mailto:info@adhdme.au?subject=Booking%20enquiry%3A%20Sarah%20Jenkins', book_label='Enquire about Sarah', book_external=False,
         fee_badge='Fees at booking',
         fees=[('Sensory profile assessment','Fee and any Medicare rebate confirmed before you book','TBC'),('Follow-up sessions','Fee and any Medicare rebate confirmed before you book','TBC')],
         fee_note='Exact fees and eligible Medicare rebates will be displayed here before booking opens.',
         quote='ADHD is not a motivation problem. Change the sensory load, the environment and the scaffolding, and the person often changes with it.',
         promises=[('tune','#2563eb','Sensory-Aware'),('receipt_long','#d97706','Written Summary'),('favorite','#2563eb','Zero Judgment')],
         bio=['Sarah Jenkins is an occupational therapist with a passion for ADHD. Her work centres on the practical side of living with an ADHD brain: sensory profiling, executive functioning scaffolding, and workplace and study accommodations that actually stick. She consults in Paddington and by clinic visit.', PLACEHOLDER_NOTE],
         focus=['ADHD-focused occupational therapy','Sensory profiling','Executive functioning scaffolding','Workplace and study accommodations'],
         details=[('Languages','To be confirmed'),('Qualifications','To be confirmed'),('Appointments','To be confirmed'),('Consulting Mode','Paddington practice &amp; clinic visits')],
         stepfree='Not declared', newpatients='Enquire',
         articles=[('occupational-therapy','rec'),('time-blindness-work','clin'),('improve-executive-function','prac')]),

    dict(slug='claire-brennan', name='Claire Brennan', short='Claire', creds='Counsellor &amp; Nutritionist',
         category='Counsellor &amp; Nutritionist • Passionate about ADHD', img='assets/claire-brennan.jpg',
         verified='Profile in progress', location='Telehealth &amp; Sydney CBD', placeholder=True,
         chips=[('favorite','Passionate about ADHD','amber'),('videocam','Telehealth','blue'),('dot','ADHD-informed counselling','dot'),('restaurant','Nutrition for ADHD','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         book_href='mailto:info@adhdme.au?subject=Booking%20enquiry%3A%20Claire%20Brennan', book_label='Enquire about Claire', book_external=False,
         fee_badge='Fees at booking',
         fees=[('Counselling session','Fee confirmed before you book','TBC'),('Nutrition consultation','Fee confirmed before you book','TBC')],
         fee_note='Exact fees will be displayed here before booking opens.',
         quote='What you eat, how you sleep and how you talk to yourself all shape an ADHD day. I work on all three, without shame and without fad diets.',
         promises=[('videocam_off','#2563eb','Camera Optional'),('restaurant','#d97706','No Fad Diets'),('favorite','#2563eb','Zero Judgment')],
         bio=['Claire Brennan is a counsellor and nutritionist with a passion for ADHD. She combines ADHD-informed counselling with practical nutrition support, helping adults build routines around food, sleep and self-talk that work with an ADHD brain rather than against it. She consults by telehealth and from Sydney CBD.', PLACEHOLDER_NOTE],
         focus=['ADHD-informed counselling','Nutrition for ADHD brains','Habit and routine support','Telehealth and in-person sessions'],
         details=[('Languages','To be confirmed'),('Qualifications','To be confirmed'),('Appointments','To be confirmed'),('Consulting Mode','Telehealth &amp; Sydney CBD')],
         stepfree='Not declared', newpatients='Enquire',
         articles=[('healthy-eating-adults','rec'),('nutrition-relationship-food','clin'),('emotional-resilience','prac')]),
]
