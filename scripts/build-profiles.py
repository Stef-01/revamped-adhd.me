...
CLINICIANS = [
    ...
    dict(slug='dr-anu-saxena', name='Dr Anu Saxena', short='Dr Anu Saxena', creds='MD, FRACGP',
         ...
         fee_badge='AU Eligible',
         fees=[('Initial consultation','Appointment lengths and fees set with the practice','Set by practice'),('Review appointments','Fees and any Medicare rebate shown at booking','Set by practice')],
         fee_note='Exact fees and eligible Medicare rebates are shown on the practice booking page before you confirm.',
    ...
    dict(slug='sarah-jenkins', name='Sarah Jenkins', short='Sarah', creds='Occupational Therapist',
         category='Occupational Therapist • Sensory &amp; Executive Function', img='assets/sarah-jenkins.jpg',
         verified='Profile in progress', location='Paddington &amp; Clinic Visit', placeholder=True,
         chips=[('sensors','Sensory profiling','blue'),('account_tree','Executive functioning scaffolding','amber'),('dot','Workplace accommodations','dot'),('home_health','Clinic visits','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         ...
         fee_note='Exact fees and eligible Medicare rebates will be displayed here before booking opens.',
         quote='Most “motivation” problems are environment problems. Change the sensory load and the scaffolding, and the person often changes with it.',
         promises=[('tune','#2563eb','Sensory-Aware'),('receipt_long','#d97706','Written Summary'),('favorite','#2563eb','Zero Judgment')],
         bio=['Sarah Jenkins is an occupational therapist listed in the ADHDme network for sensory profiling, executive functioning scaffolding, and workplace accommodations, consulting in Paddington and by clinic visit.', PLACEHOLDER_NOTE],
         focus=['Sensory profiling','Executive functioning scaffolding','Workplace accommodations','Environment and routine design'],
    ...
    dict(slug='claire-brennan', name='Claire Brennan', short='Claire', creds='Body Doubling Facilitator',
         category='Allied Health • Body Doubling &amp; Habit Formation', img='assets/claire-brennan.jpg',
         verified='Profile in progress', location='Telehealth &amp; Sydney CBD', placeholder=True,
         chips=[('videocam','Telehealth','blue'),('group','Body doubling facilitator','amber'),('dot','Habit formation','dot'),('timer','Time perception tools','green')],
         accepting='<span class="font-semibold text-black">Enquiries welcome</span> • Online booking coming soon',
         ...
         fee_badge='Fees at booking',
         fees=[('Body doubling session','Fee confirmed before you book','TBC'),('Habit and time-tools program','Fee confirmed before you book','TBC')],
         fee_note='Exact fees will be displayed here before booking opens.',
         quote='Starting is the hard part. Having someone quietly alongside you is the least complicated tool there is, and one of the most reliable.',
         promises=[('group','#2563eb','Alongside You'),('timer','#d97706','Time Made Visible'),('favorite','#2563eb','Zero Judgment')],
         bio=['Claire Brennan is a body doubling facilitator listed in the ADHDme network for habit formation and time perception tools, working by telehealth and from Sydney CBD.', PLACEHOLDER_NOTE],
         focus=['Body doubling sessions','Habit formation','Time perception tools','Telehealth and in-person sessions'],
         ...
         stepfree='Not declared', newpatients='Enquire',
         articles=[('body-doubling','rec'),('losing-track-of-time','clin'),('time-perception','prac')]),
]
